...
export function Header() {
  ...
  return (
    <motion.header
      ...
      dir="ltr"
    >
      <div className="container mx-auto px-6 py-4 flex flex-row items-center">
        {isProductPage ? (
          <motion.div
          ...
          >
            <Button
              variant="outline"
              onClick={() => router.back()}
              className="gap-2 cursor-pointer bg-slate-800/80 hover:bg-slate-800 border-slate-700"
            >
